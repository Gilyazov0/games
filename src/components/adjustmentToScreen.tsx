...
export function adjustmentToScreenSize(rowsCount:number,colsCount:number):[number,Direction]{
   ...
   const direction: Direction = cellSizeByRows > cellSizeByCols? Direction.column:Direction.row; 
